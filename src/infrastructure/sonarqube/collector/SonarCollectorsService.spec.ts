import { StaticAnalysisCollectorConfig } from './Types';
...
describe('SonarCollectorsService', () => {
  ...
  const sonarCollectorsService: SonarCollectorsService =
    new SonarCollectorsService(sonarService);

  it('should fetch sonarMetrics', async () => {
    const staticAnalysisCollectorConfig: StaticAnalysisCollectorConfig =
      new StaticAnalysisCollectorConfig({
    ...
    const data = await sonarCollectorsService.fetch(
      staticAnalysisCollectorConfig
    );
